...
# url_list = ["https://s3-ap-southeast-1.amazonaws.com/biz.thestar.com.my/json/{}/stocks.js".format(_) for _ in list(string.ascii_uppercase)]


# xx = [{"etf": "etfbond"},{"main_market": "closedfund"}]

# url_list= ["https://s3-ap-southeast-1.amazonaws.com/biz.thestar.com.my/json/sectors/{0}/{1}/stocks.js".format(k, v) for item in xx for k,v in item.items()]

# https://s3-ap-southeast-1.amazonaws.com/biz.thestar.com.my/json/sectors/main_market/healthcare/stocks.js
#
# https://s3-ap-southeast-1.amazonaws.com/biz.thestar.com.my/layout/stocks/loadsec.js
...
def get_data(name, sector, subsector):
    start_date = "1426118400"
    # start_date = "1522678069"
    # end_date= "1553834927"
    # end_date ="1555434334"
    end_date = "1555545600"
